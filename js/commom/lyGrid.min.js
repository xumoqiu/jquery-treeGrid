...
(function($) {
    $.fn.lyGrid = (function(options) {
        ...
        var createBody = function(jsonData) {
            ...
            if (CommonUtil.notNull(jsonData)) {
                ...
                if (String(conf.usePage) == "true") {
                    ...
                    $("#" + grid.id + " div.fixed-table-pagination").remove();
                }
            } else {
                ...
                function(o) {
                    if (!column[o].hide || column[o].hide == undefined) {
                        ...
                        if (column[o].isSort) {
                            ...
                            sortDiv.className = "sortable both";
                            sortDiv.innerHTML = column[o].name;
                            th.append(sortDiv);
                        } else {
            ...
            if (String(conf.isFixed) == "false") {
                ...
                $.each(column,
                    function(o) {
                        ...
                        var at = "vertical-align: middle;"                       
                        if(!!column[o].align){
                            at += "text-align:" + column[o].align + ";";
                        }                        
                        if(!!column[o].width){
                            at += "width: " + column[o].width + ";";

                        }
                        if(!!conf.theadHeight){
                            at += "height:" + conf.theadHeight + ";";
                        }
                        ...
                        if (column[o].isSort) {
                            ...
                            sortSpan.onclick = sortBind.bind();
                ...
                if (CommonUtil.notNull(rowdata) && !CommonUtil.in_array(jlist, d)) {
                    ...
                    $.each(column,
                        function(o) {
                            ...
                            if(!!column[o].tbodyClass){
                                td_o.className = column[o].tbodyClass;
                            }


                            var at =  "vertical-align: middle;word-break:break-all;word-wrap: break-word;";
                            if(!!column[o].align){
                                at += "text-align:" + column[o].align +";"; 
                            }
                            if(!!column[o].width){
        ...
        var pagenation = function(jsonData) {
            $("#" + grid.id + " div.fixed-table-pagination").remove();
            ...
            var fixPageDiv = document.createElement("div");
            fixPageDiv.className = "fixed-table-pagination";
            grid.appendChild(fixPageDiv);

            var pageDetailDiv = document.createElement("div");
            pageDetailDiv.className = "float-left pagination-detail";
            fixPageDiv.appendChild(pageDetailDiv);


            var pageInfoSpan = document.createElement("span");
            pageInfoSpan.className = "pagination-info";
            pageInfoSpan.innerText = "Showing " + currentStartPage + " to " + currentEndPage + " of " + totalRecords + " rows";

            var pageListSpan = document.createElement("span");
            pageListSpan.className = "page-list";
            ...
            if (String(conf.selectPage) == "true") {
                var pageListSpan_select = document.createElement("select");
                pageListSpan_select.setAttribute("style", "display:inline-block!important;width:auto;");
                pageListSpan_select.className = "form-control";
                pageListSpan_select.onchange = pageBind.bind();
                pageListSpan.appendChild(pageListSpan_select);
                pageListSpan_text = document.createTextNode(" rows per page");
                pageListSpan.appendChild(pageListSpan_text);
                var sp = conf.selectPageSize;
                for (var it = 0; it < sp.length; it++) {
                    var op = new Option(sp[it], sp[it]);
                    pageListSpan_select.options.add(op);
            ...
            pageDetailDiv.appendChild(pageInfoSpan);
            pageDetailDiv.appendChild(pageListSpan);

            var goPageDiv = document.createElement("div");
            goPageDiv.className = "float-right pagination"
            fixPageDiv.appendChild(goPageDiv);


            var goPageDiv_ul = document.createElement("ul");
            goPageDiv_ul.className = "pagination";
            goPageDiv.appendChild(goPageDiv_ul);

            if (String(conf.goPage) == "true") {

                var goPageDiv_div = document.createElement("div");
                goPageDiv_div.className = "page-go input-group";
                goPageDiv.appendChild(goPageDiv_div);


                var goPageDiv_div_input = document.createElement("input");
                goPageDiv_div_input.onkeydown = pageBind.bind();
                goPageDiv_div_input.className = "form-control";
                goPageDiv_div_input.type = "text";
                goPageDiv_div_input.value = pageNow;
                goPageDiv_div.appendChild(goPageDiv_div_input);




                var goPageDiv_div_span = document.createElement("span");
                goPageDiv_div_span.className = "input-group-btn";
                goPageDiv_div.appendChild(goPageDiv_div_span);



                var goPageDiv_div_span_button = document.createElement("button");
                goPageDiv_div_span_button.onclick = pageBind.bind();

                goPageDiv_div_span_button.className = "btn btn-primary btn_page_go";
                goPageDiv_div_span_button.innerHTML = "Go";
                goPageDiv_div_span_button.id = "btn_page_go";
                goPageDiv_div_span.appendChild(goPageDiv_div_span_button);

            }

            if (pageNow > 1) {
                var goPageDiv_ul_li = document.createElement("li");
                goPageDiv_ul_li.className = "page-item page-pre";
                goPageDiv_ul.appendChild(goPageDiv_ul_li);

                var goPageDiv_ul_li_a = document.createElement("a");
                goPageDiv_ul_li_a.onclick = pageBind.bind();
                goPageDiv_ul_li_a.className = "page-link";
                goPageDiv_ul_li_a.id = "pagNum_" + (pageNow - 1);
                goPageDiv_ul_li_a.href = "javascript:void(0);";
                goPageDiv_ul_li_a.innerHTML = "<";
                goPageDiv_ul_li.appendChild(goPageDiv_ul_li_a);

            } else {
                var goPageDiv_ul_li = document.createElement("li");
                goPageDiv_ul_li.className = "page-item page-prev disabled";
                goPageDiv_ul.appendChild(goPageDiv_ul_li);
            ...
            var pg = pagesIndex(conf.switchPageCount, pageNow, totalPages);
            var startpage = pg.start;
            var endpage = pg.end;
            if (startpage != 1) {
                var goPageDiv_ul_li1 = document.createElement("li");
                goPageDiv_ul_li1.className = "page-item";
                goPageDiv_ul.appendChild(goPageDiv_ul_li1);

                var goPageDiv_ul_li1_a = document.createElement("a");

                goPageDiv_ul_li1_a.onclick = pageBind.bind();
                goPageDiv_ul_li1_a.className = "page-link";
                goPageDiv_ul_li1_a.href = "javascript:void(0);";
                goPageDiv_ul_li1_a.id = "pagNum_1";
                goPageDiv_ul_li1_a.innerHTML = "1...";
                goPageDiv_ul_li1.appendChild(goPageDiv_ul_li1_a);
            }

            for (var i = startpage; i <= endpage; i++) {
                if (i == pageNow) {
                    var goPageDiv_ul_li2 = document.createElement("li");
                    goPageDiv_ul_li2.className = "page-item active";
                    goPageDiv_ul.appendChild(goPageDiv_ul_li2);

                    var goPageDiv_ul_li2_a = document.createElement("a");
                    goPageDiv_ul_li2_a.className = "page-link";
                    goPageDiv_ul_li2_a.href = "javascript:void(0);";
                    goPageDiv_ul_li2_a.innerHTML = i;
                    goPageDiv_ul_li2.appendChild(goPageDiv_ul_li2_a);
                } else {
                    var goPageDiv_ul_li2 = document.createElement("li");
                    goPageDiv_ul_li2.className = "page-item";
                    goPageDiv_ul.appendChild(goPageDiv_ul_li2);

                    var goPageDiv_ul_li2_a = document.createElement("a");
                    goPageDiv_ul_li2_a.className = "page-link";
                    goPageDiv_ul_li2_a.onclick = pageBind.bind();
                    goPageDiv_ul_li2_a.href = "javascript:void(0);";
                    goPageDiv_ul_li2_a.id = "pagNum_" + i;
                    goPageDiv_ul_li2_a.innerHTML = i;
                    goPageDiv_ul_li2.appendChild(goPageDiv_ul_li2_a);
                }
            }
            ...
            if (endpage != totalPages) {
                var goPageDiv_ul_li3 = document.createElement("li");
                goPageDiv_ul_li3.className = "page-item";
                goPageDiv_ul.appendChild(goPageDiv_ul_li3);

                var goPageDiv_ul_li3_a = document.createElement("a");
                goPageDiv_ul_li3_a.className = "page-link";
                goPageDiv_ul_li3_a.onclick = pageBind.bind();
                goPageDiv_ul_li3_a.href = "javascript:void(0);";
                goPageDiv_ul_li3_a.id = "pagNum_" + totalPages;
                goPageDiv_ul_li3_a.innerHTML = "..." + totalPages;
                goPageDiv_ul_li3.appendChild(goPageDiv_ul_li3_a);
            }

            if (pageNow >= totalPages) {
                var goPageDiv_ul_li4 = document.createElement("li");
                goPageDiv_ul_li4.className = "page-item page-prev disabled";
                goPageDiv_ul.appendChild(goPageDiv_ul_li4);

                var goPageDiv_ul_li4_a = document.createElement("a");
                goPageDiv_ul_li4_a.className = "page-link";
                goPageDiv_ul_li4_a.href = "javascript:void(0);";
                goPageDiv_ul_li4_a.innerHTML = ">";
                goPageDiv_ul_li4.appendChild(goPageDiv_ul_li4_a);
            } else {
                var goPageDiv_ul_li4 = document.createElement("li");
                goPageDiv_ul_li4.className = "page-item page-next";
                goPageDiv_ul.appendChild(goPageDiv_ul_li4);

                var goPageDiv_ul_li4_a = document.createElement("a");
                goPageDiv_ul_li4_a.className = "page-link";
                goPageDiv_ul_li4_a.onclick = pageBind.bind();
                goPageDiv_ul_li4_a.href = "javascript:void(0);";
                goPageDiv_ul_li4_a.id = "pagNum_" + (pageNow + 1);
                goPageDiv_ul_li4_a.innerHTML = ">";
                goPageDiv_ul_li4.appendChild(goPageDiv_ul_li4_a);
            }
        };
        ...
        var pageBind = function(e) {
            ...
            if (b) {
                ...
                var pageSize = $(obj).parents("div.fixed-table-pagination").find("select").eq(0).val(); // $(obj).parent().parent().find("select").eq(0).val();
                if (obj.nodeName == "INPUT") {
                    ...
                    if (obj.nodeName == "SELECT") {
                        ...
                        if (obj.id == "btn_page_go") {
                            page = obj.parentNode.previousSibling.value;
                        } else {
                            if (obj.nodeName == "A") {
        ...
        var sortBind = function() {
            ...
            $("#" + grid.id).find("table thead th div.sortable").not($(sortObj)).removeClass("asc").removeClass("desc");
        ...
        var pagesIndex = function(switchPageCount, pageNow, pageCount) {
            switchPageCount = parseInt(switchPageCount, 10);
            pageNow = parseInt(pageNow, 10);
            pageCount = parseInt(pageCount, 10);
            var startpage = pageNow - (switchPageCount % 2 == 0 ? switchPageCount / 2 - 1 : switchPageCount / 2);
            var endpage = pageNow + switchPageCount / 2;
            if (startpage < 1) {
                startpage = 1;
                if (pageCount >= switchPageCount) {
                    endpage = switchPageCount;
                } else {
                    endpage = pageCount;
                }
            }
            if (endpage > pageCount) {
                endpage = pageCount;
                if ((endpage - switchPageCount) > 0) {
                    startpage = endpage - switchPageCount + 1;
                } else {
                    startpage = 1;
                }
            }
